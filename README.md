...
- Collapsible Avatar Style controls with eight avatar colors; Smooth, Rough, a dense animated Point Cloud, and a high-visibility thick-bone skeleton with joint nodes; Studio, Bright, Side Light, Rim, and Silhouette lighting presets; and independent Neutral, Warm, Cool, Cyan, Magenta, and Red lighting colors
